...
public class Task3_loginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_task3_login);
        ...
        tv_l_user.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Task3_loginActivity.this,Task3_RegisterActivity.class));
            }
        });
        //forget password
        tv_l_forgot_pswd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Task3_loginActivity.this,Task3_ForgotpswdActivity.class));
            }
        });
        // no1
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SIGN_IN){
            ...
            try {
                ...
                Toast.makeText(Task3_loginActivity.this,"failed" + e.getMessage(),Toast.LENGTH_LONG).show();
            }
        }
    }
    //no1
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()){
                            Intent intent = new Intent(Task3_loginActivity.this,Task3_Deshboard.class);
                            startActivity(intent);
                        }else {
                            Toast.makeText(Task3_loginActivity.this,"not done varification",Toast.LENGTH_LONG).show();
                        }
                    }
                });
    }
    ...
    private void loginUser() {
        ...
        if (TextUtils.isEmpty(email1) || TextUtils.isEmpty(paswd1)){
            Toast.makeText(Task3_loginActivity.this,"enter details",Toast.LENGTH_SHORT).show();
        }
        else {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful()){
                        ...
                        if (auth.getCurrentUser().isEmailVerified()){
                            startActivity(new Intent(Task3_loginActivity.this,Task3_Deshboard.class));
                        }
                        else {
                            Toast.makeText(Task3_loginActivity.this,"not done varification",Toast.LENGTH_SHORT).show();
                        }
                    }
                    else {
                        Toast.makeText(Task3_loginActivity.this,"oops!failed" + task.getException().getMessage(),Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
